 ...
 * @author MIRKO
 */
public class CreateVariable extends javax.swing.JDialog {
    DefaultListModel<String> modelo = new DefaultListModel<>();
    JPanel parentPanel;
    /**
     * Creates new form CreateVariable
     */
    public CreateVariable(java.awt.Frame parent, boolean modal, JPanel parentPanel) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Crear nueva variable");
            ...
            .addGroup(valoresEscalarLayout.createSequentialGroup()
                ...
                .addGroup(valoresEscalarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(valoresEscalarLayout.createSequentialGroup()
                        ...
                        .addComponent(valor_variable, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(valoresEscalar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(32, 32, 32))))
        );
    ...
    private void tipo_variableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tipo_variableActionPerformed
        ...
        if(tipo == "Escalar"){
            this.desabilitarJpanel(valoresNumerica);
            this.habilitarJpanel(valoresEscalar);
        }else{
            this.desabilitarJpanel(valoresEscalar);
            this.habilitarJpanel(valoresNumerica);
        }
    }//GEN-LAST:event_tipo_variableActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String tipo = tipo_variable.getSelectedItem().toString();
        if(tipo == "Numerica") this.crearVariableNumerica();
        else this.crearVariableEscalar();
        VariablesPanelForm name = (VariablesPanelForm)this.parentPanel;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateVariable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CreateVariable dialog = new CreateVariable(new javax.swing.JFrame(), true, null);
    ...
    private void crearVariableNumerica() {
        ...
        if(!this.limite_sup.getText().matches(regex)) JOptionPane.showMessageDialog(null, "Formato del campo Limite superior no es el correcto");
            ...
            ((MainFrame)this.getParent()).variables.addVariableNumerica(nombre, descripcion, min, max, lim_sup, lim_inf);
        }
    }

    private void crearVariableEscalar() {
        String nombre = this.nombre_variable.getText();
        ...
        ((MainFrame)this.getParent()).variables.addVariableEscalar(nombre, descripcion, valores);
    }
}
